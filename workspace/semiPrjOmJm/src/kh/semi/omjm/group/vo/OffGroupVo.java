...
public class OffGroupVo {
	...
	public OffGroupVo(String no, String name, String leaderNo, String groupNo, String userCnt, String offDate,
			String content, String enrollDate, String modifyDate, String deleteYn) {
		super();
		this.no = no;
		this.name = name;
	...
	public String toString() {
		return "OffGroupVo [no=" + no + ", name=" + name + ", leaderNo=" + leaderNo + ", groupNo=" + groupNo
				+ ", userCnt=" + userCnt + ", offDate=" + offDate + ", content=" + content + ", enrollDate="
				+ enrollDate + ", modifyDate=" + modifyDate + ", deleteYn=" + deleteYn + "]";
	}
